...
using PortersonToXml2.Services;

namespace PortersonToXml2.Tests
{
    public class IntegrationTests
    {
        private const string Input = @"<?xml version=""1.0""?>
        <catalog>
            <book id=""bk101"">
        ...
        {
            var catalog = DataProcessor.Deserialize(Input);

            Assert.AreEqual(12, catalog.Books.Count);
        }
        
        [Test]
        public void To_format_1()
        {
            ...
            var actual = DataProcessor.SerializeToXml1(_2);

            AssertXml(expected, actual);
        }

        [Test]
        public void To_format_2()
        {
            var expected = @"<?xml version=""1.0"" encoding=""utf-8""?>
            <catalog>
                <authors>
            ...
            var _1 = DataProcessor.Deserialize(Input);
            var _2 = DataProcessor.Transform(_1);
            var actual = DataProcessor.SerializeToXml2(_2);
